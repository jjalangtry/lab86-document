...
import { BookOpen, ChevronRight, MoreHorizontal, PenLine } from 'lucide-react';
...
type Props = {
  path: string; text: string; mode: Mode; resolve: Resolver;
  host: () => EditorHost;
...
export function NoteView(props: Props) {
  const { path, text, mode, resolve, host, editorRef, articleRef, focusTitle, justRenamed } = props;
